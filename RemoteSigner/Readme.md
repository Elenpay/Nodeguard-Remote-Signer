...
Execute unit tests
```
cd "RemoteSigner/test/RemoteSigner.Tests"
dotnet test
```
...
docker tag registry.gitlab.com/clovrlabs/lightningnetwork/fundsigner:develop 839166930136.dkr.ecr.eu-central-1.amazonaws.com/RemoteSigner:latest
